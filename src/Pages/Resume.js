...
import { DesktopWindows, Laptop, School } from "@material-ui/icons";
    ...
    {info ? (
      <>
        {info.map((information) => (
          <h3 style={{ margin: 0, fontSize: "20px", color: "grey" }}>
            {information}
          </h3>
        ))}
      </>
    ) : null}
    <p style={{ fontSize: "17px", margin: "10px 0 0 0" }}>{content}</p>
  </div>
);
...
const skills = [
  {
    title: "Javascript",
    description:
      "A scripting or programming language that allows you to implement complex features on web pages. In the last decade, it has gone from one of the three languages  of the internet (the others being HTML and CSS) to a full blown ecosystem that is the backbone of modern web development",
    icon: (
      <Icon
        component={JavascriptLogo}
        style={{ fontSize: "2.5em", color: "#A5037A" }}
      />
    ),
  },
  {
    title: "React",
    description:
      "A Javascript library (not a framework, but kind of a framework) that allows for dynamic webpages and more natural UI/UX. By far the most popular of the frontend JS libraries/frameworks. Used in most of my personal projects, and extensively in my work experience",
    icon: (
      <Icon
        component={ReactLogo}
        style={{ fontSize: "2.5em", color: "#A5037A" }}
  ...
  },
  {
    title: "C# / .Net",
    description:
      'The tried and true "Microsoft Java". A strongly-typed object-oriented powerhouse that has been around since the year 2000. Most of my experience with C# has been through school assignments using the MVC framework of .NET. I love how secure this language is, but is not as rapid as I would like',
    icon: (
      <Icon
  ...
  },
  {
    title: "NodeJS",
    description:
      "People love Javascript so much, they put it on the backend. A single-threaded (mostly) server-side language built on C++ and the Chromium engine. I've used this extensively on every personal project I've ever undertaken. It allows for easily implemented real-time socket communication",
    icon: (
      <Icon
        component={NodeLogo}
        style={{ fontSize: "2.5em", color: "#A5037A" }}
  ...
  },
  {
    title: "MongoDB",
    description:
      'A NoSQL database that is based on JSON documents. Guess what the "J" in JSON stands for? Yup, Javascript. I like using what is known as the MERN stack. Mongo, Express, React, and Node because it relies on a single underlying language. SQL is great, but I personally prefer NoSQL most of the time',
    icon: (
      <Icon
        component={MongoLogo}
        style={{ fontSize: "2.5em", color: "#A5037A" }}
  ...
  },
  {
    title: "CSS / SASS / LESS",
    description:
      "I chose to group these as they all handle styling. CSS is the original styling language, and what SASS and LESS are based off of. SASS and LESS are style pre-processors that allow to do things like add variables to your styles. I personally prefer React's inline styling, but it is also based on CSS",
    icon: (
      <Icon
        component={CssLogo}
        style={{ fontSize: "2.5em", color: "#A5037A" }}
    ...
    content: (
      <>
        <div style={{ display: "flex", flexDirection: "column" }}>
          <Card
            title="Ellement Consulting Group"
            info={["Lead Frontend Developer", "Software Developer"]}
            content="I am currently the lead frontend developer on a small team creating an app for the insurance sector. THe stack is pretty similar to my other positions, but using Svelte rather than React."
          />
        </div>
